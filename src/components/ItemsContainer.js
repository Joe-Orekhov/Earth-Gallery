...
function ItemsContainer({ displayedItems = [], buttonText, handleSubmitEdit, selectUser } ){
  ...
  return(
    <div className="cards-container">
      ...
      {displayedItems.map(item => { return <ItemCard key={item.id} item={item} selectUser={selectUser} buttonText={buttonText} buttonValue={location.pathname === "/sell" ? "edit" : "addToCart"} handleSubmitEdit={handleSubmitEdit}/>} )}
    </div>
  )
}
